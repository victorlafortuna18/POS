...
@section('body')
	...
	<div class="container" style="display:none;height:0px;position:absolute;left:;top:;z-index:100000;">	
		<div class="panel panel-default col-md-4 center" style="float:right;position:absolute;top:75px;right:40px;width:250px;background:rgba(255,255,255,0.95);">
			<span style="font-size:14px;">Actualizar&aacute; en </span> <span class="text" id="contadorDesc" style="font-size:20px;">10</span>
			<i id="playpause" data-playpause="1" class="fa fa-pause" style="margin-left:10px;" aria-hidden="true"></i>
		</div>
	</div>
	
	<div class="container" style="display:block;height:0px;position:absolute;left:;top:;z-index:100000;">	
		<div class="panel panel-default col-md-4 center" style="float:right;position:absolute;top:75px;right:40px;width:250px;background:rgba(255,255,255,0.95);">
			<span style="font-size:14px;"> Distancia </span> <span class="text" id="distancia" style="font-size:20px;">0</span> Mts
		</div>
	</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content" style="position:relative;top:100px;">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel"><i class="fa fa-thumbs-o-up fa-2x"></i> Orden entregada!!</h4>
				</div>

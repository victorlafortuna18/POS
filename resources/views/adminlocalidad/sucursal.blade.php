	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-heading"> Sucursales encontradas ( {{ $conteoSucursales }} ) 
				<div class="panel-body">
					<div class="panel-body">
								...
								<tr data-url="edit-sucursal" data-id="{{ $sucursal->id }}" data-longitud="{{ $sucursal->longitud }}" data-latitud="{{ $sucursal->latitud }}">
									...
									<td>
										@if($conteoOperadorPorSucursal == 0)
											<a href="{{ url('adminlocalidad/usuario')}}">Agregar</a> <a href="{{ url('admin/usuario')}}" style="float:right;"><i class="fa fa-plus-square"></i></a>
										@else
											{{$conteoOperadorPorSucursal}} <a href="{{ url('adminlocalidad/usuario')}}" style="float:right;"><i class="fa fa-plus-square"></i></a>
										@endif
									</td>
									...
									<td>
										@if($conteoMensajerosPorSucursal == 0)
											<a href="{{ url('adminlocalidad/mensajero')}}">Agregar</a> <a href="{{ url('admin/mensajero')}}" style="float:right;"><i class="fa fa-plus-square"></i></a>
										@else
											{{$conteoMensajerosPorSucursal}} <a href="{{ url('adminlocalidad/mensajero')}}" style="float:right;"><i class="fa fa-plus-square"></i></a>
										@endif
									</td>

						...
						<div class="list-group">
							<table id="tablaReportePedidoMensajero" class="display" cellspacing="0" width="100%">
								...
								@else
									...
									<tr>
										<td>
											<a href="{{ url('adminlocalidad/reporte/pedidoMensajeroDetalle/'.$mensajero->id.'?desde='.$desde.'&hasta='.$hasta) }}" id="itemMensajero" name="{{$mensajero->id}}">{{$mensajero->nombreUsuario}}</a> 
										</td>

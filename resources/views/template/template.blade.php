...
<html lang="en">
		...
		<nav class="navbar">
				<div class="container-fluid default-color">
					<div class="navbar-header">
						...
						<a class="navbar-brand waves-effect waves-light" href="{{ url('/') }}">Smart delivery</a>
	...
	@if(isset($_GET['editado']))
		...
		@elseif($_GET['editado'] == 'error')
			<div class="notificacionesError notificacion"><div class="btn-warning">Error al editar. Esto se debe a que esta siendo usada internamente!  <a href="#" class="cerrarNotificacion" style="float:right;font-weight:bold;">&times;</a></div></div>
		@endif
	@endif

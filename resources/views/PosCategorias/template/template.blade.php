		...
		<nav class="navbar" style="z-index:10000;">
				<div class="container-fluid default-color">
					<div class="navbar-header">
						...
						<a class="navbar-brand waves-effect waves-light" href="{{ url('adminlocalidad/dashboard') }}">SmartDelivery</a> 
						<a class="navbar-brand waves-effect waves-light" href="#" onclick="location.reload();">  @yield('page-title')</a>
						<a class="navbar-brand waves-effect waves-light facturacion" href="#" style="display:none;"> Facturacion</a>
						<a class="navbar-brand waves-effect waves-light cierreCaja" href="#"> <i class="fa fa-sign-out" aria-hidden="true"></i> Cerrar Caja</a>

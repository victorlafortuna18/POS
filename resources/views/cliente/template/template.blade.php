		...
		<nav class="navbar" style="z-index:10000;">
				<div class="container-fluid default-color">
					<div class="navbar-header">
						...
						<a class="navbar-brand waves-effect waves-light" href="#">Smart delivery</a> 
						<a class="navbar-brand waves-effect waves-light" href="#" onclick="location.reload();">  @yield('page-title')</a>
						
					</div>
				<a class="navbar-brand waves-effect waves-light" href="{{ url('logout') }}" style="float:right;display:none;">Cerrar sesion</a>
				</div>

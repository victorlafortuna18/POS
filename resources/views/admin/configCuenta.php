	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-heading">Configuracion general de la cuenta</div>
				<div class="panel-body">
					<div class="panel-body">
							...
							<table id="tablaUsuarios" class="display" cellspacing="0" width="100%">
								<thead>
									...
									<tr>
										...
										<td class="active"><a class="cambiarNombre" href="#">-Name-</a></td>
									</tr> 
									<tr>  
										<td class="active">Nombre de usuario</td>
										<td class="active"><a class="cambiarNombre" href="#">-Username-</a></td>
									</tr> 
									<tr>  
										<td class="active">Clave de acceso</td>
										<td class="active"><a class="cambiarClave" href="#">Cambiar</a></td>
									</tr>

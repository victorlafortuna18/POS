								...
								<tr data-url="edit-sucursal" data-id="{{ $mensajero->id }}" data-edit="{{ $mensajero->userID }}">
									...
									<td>
										@if($mensajero->activo == 1)
											<input id="toggle-one" type="checkbox" class="switchestatusmensajero" checked data-toggle="toggle" data-mensajeroid="{{$mensajero->id}}" data-estatus="0" data-on="<i class='fa fa-user'></i> On" data-off="<i class='fa fa-user-times'></i> Off" data-size="mini">
										@else
											<input id="toggle-one" type="checkbox" class="switchestatusmensajero" data-toggle="toggle" data-mensajeroid="{{$mensajero->id}}" data-estatus="1" data-on="<i class='fa fa-user'></i> On" data-off="<i class='fa fa-user-times'></i> Off" data-size="mini">
										@endif
									</td>
								</tr>
								@endforeach

					...
					<div class="panel-body">
						<div class="col-lg-6">
							...
							<div class="input-group" style="display:block;color:;font-weight:bold;background:;border:0px solid #333;">
								<a href="{{ url('adminlocalidad/dashboard') }}"><i class="fa fa-home"></i> Admin</a> >> <a href="{{ url('admin/reporte/pedidoMensajero') }}">Pedidos x Mensajero</a> >> <a href="#">{{ $mensajero->nombreUsuario }}</a>
							</div><!-- /input-group -->
						</div><!-- /.col-lg-6 -->
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="panel-body" style="position:relative;">
						...
						<form method="post" action="{{ $mensajero->id }}" style="position:absolute;left:15px;top:0px;z-index:10000;">

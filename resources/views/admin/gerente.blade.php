...
<div class="container-fluid">
	...
	<?php 
		//Generando un conteo de los gerentes
		//*************************************
		$conteoGerentes = 0;
	?>
	@if (empty($gerentes))
					...
					<div class="panel-body">
						<div class="col-lg-6">
							...
							<div class="input-group" style="display:block;color:;font-weight:bold;background:;border:0px solid #333;">
								<a href="dashboard"><i class="fa fa-home"></i> Admin</a> >> <a href="#">Gerentes</a>
							</div><!-- /input-group -->
						</div><!-- /.col-lg-6 -->
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-heading"> Gerentes encontrados ( {{ $conteoGerentes }} ) <a href="#" id="agregarMensajero" style="cursor:pointer;">Agregar nuevo</a></div>
				<div class="panel-body">
					<div class="panel-body">
						...
						<div class="list-group">
							<table id="tablaUsuarios" class="display" cellspacing="0" width="100%">
								...
								@else
								@foreach($gerentes as $gerente)
								<tr data-url="edit-sucursal" data-id="{{ $gerente->id }}" data-edit="{{ $gerente->userID }}">
									<td>
										<span id="itemMensajero" name="{{$gerente->id}}">{{$gerente->userID}}</span>
										
										<a href="#" id="eliminarMensajero" class="eliminarMensajero" data-id="{{ $gerente->id }}" data-userID="{{ $gerente->userID }}" style="font-weight:bold;float:right;position:relative;top:-3px;">&times;</a>
										<a href="#" id="editarMensajero" class="editarMensajero" data-id="{{ $gerente->id }}" data-userID="{{ $gerente->userID }}" data-telefono="{{ $gerente->telefonoUsuario }}" data-localidadID="{{ $gerente->localidadID }}" data-nombreMensajero="{{ $gerente->nombreUsuario }}" style="margin-right:15px;float:right;"><i class="fa fa-pencil-square-o"></i></a>
										<a href="#" id="editarMensajeroPassword" class="editarMensajeroPassword" data-id="{{ $gerente->id }}" data-userID="{{ $gerente->userID }}" data-telefono="{{ $gerente->telefonoUsuario }}" data-localidadID="{{ $gerente->localidadID }}" data-nombreMensajero="{{ $gerente->nombreUsuario }}" style="margin-right:15px;float:right;"><i class="fa fa-lock"></i></a>
									</td>
									<td>{{$gerente->nombreUsuario}}</td>
									<td>{{$gerente->telefonoUsuario}}</td>
									<?php $nombreSucursal = '---'; ?>
									@foreach($sucursales as $sucursal)
										@if($sucursal->id == $gerente->localidadID)
		...
		<div class="modal-dialog" role="document" style="margin:0px auto;margin-top:100px;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel"><i class="fa fa-pencil-square-o"></i> Agregar gerente</h4>
				</div>
				<form id="formAgregarMensajero" action="gerente" method="post">
					<div class="modal-body">
							
							<input type="hidden" name="_token" value="{{ csrf_token() }}">
							<input type="hidden" name="asunto" value="guardarGerente">
							...
							<input id="nombreGerente" type="text" name="nombreUsuario" class="text" value="" placeholder="Nombre de Gerente">
	...
	<div id="modalEditarMensajero" style="display:none;position:absolute;top:0px;left:0px;width:100%;height:100%;background:rgba(0,0,0,0.7);box-sizing:border-box;z-index:1000000;">
		<div class="modal-dialog" role="document" style="margin:0px auto;margin-top:100px;">
			<div class="modal-content">
				...
				<form id="formEditarMensajero" action="gerente" method="post">
					<div class="modal-body">
							<input type="hidden" name="_token" value="{{ csrf_token() }}">
							<input type="hidden" name="asunto" value="editarGerente">
	...
	<div id="modalEditarMensajeroPassword" style="display:none;position:absolute;top:0px;left:0px;width:100%;height:100%;background:rgba(0,0,0,0.7);box-sizing:border-box;z-index:1000000;">
		<div class="modal-dialog" role="document" style="margin:0px auto;margin-top:100px;">
			<div class="modal-content">
				...
				<form id="formEditarMensajeroPassword" action="gerente" method="post">
					<div class="modal-body">
							<input type="hidden" name="_token" value="{{ csrf_token() }}">
							<input type="hidden" name="asunto" value="editarGerentePassword">
							<input type="hidden" name="id" id="id" value="">
	...
	<div id="modalEliminarMensajero" style="display:none;position:absolute;top:0px;left:0px;width:100%;height:100%;background:rgba(0,0,0,0.7);box-sizing:border-box;z-index:1000000;">
		<div class="modal-dialog" role="document" style="margin:0px auto;margin-top:100px;">
			<div class="modal-content">
				...
				<form id="formEliminarMensajero" action="gerente" method="post">
					<div class="modal-body">
							Desea eliminar <span id="modalEliminarMensajeroTitle"></span>?
							<input type="hidden" name="_token" value="{{ csrf_token() }}">
							<input type="hidden" name="asunto" value="eliminarGerente">

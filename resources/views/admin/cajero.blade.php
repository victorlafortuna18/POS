					...
					<div class="panel-body">
						<div class="col-lg-6">
							...
							<div class="input-group" style="display:block;color:;font-weight:bold;background:;border:0px solid #333;">
								<a href="dashboard"><i class="fa fa-home"></i> Admin</a> >> <a href="#">Cajeros</a>
							</div><!-- /input-group -->
						</div><!-- /.col-lg-6 -->
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-heading"> Cajeros encontrados ( {{ $conteoUsuarios }} ) <a href="#" id="agregarUsuario" style="cursor:pointer;">Agregar nuevo</a></div>
				<div class="panel-body">
					<div class="panel-body">
		...
		<div class="modal-dialog" role="document" style="margin:0px auto;margin-top:100px;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel"><i class="fa fa-pencil-square-o"></i> Agregar Cajero</h4>
				</div>
				<form id="formAgregarUsuario" action="cajero" method="post">
		...
		<div class="modal-dialog" role="document" style="margin:0px auto;margin-top:100px;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel"><i class="fa fa-pencil-square-o"></i> Editar Cajero</h4>
				</div>
				<form id="formEditarUsuario" action="cajero" method="post">
					<div class="modal-body">
							<input type="hidden" name="_token" value="{{ csrf_token() }}">
	...
	<div id="modalEditarUsuarioPassword" style="display:none;position:absolute;top:0px;left:0px;width:100%;height:100%;background:rgba(0,0,0,0.7);box-sizing:border-box;z-index:1000000;">
		<div class="modal-dialog" role="document" style="margin:0px auto;margin-top:100px;">
			<div class="modal-content">
				...
				<form id="formEditarUsuarioPassword" action="cajero" method="post">
					<div class="modal-body">
							<input type="hidden" name="_token" value="{{ csrf_token() }}">
		...
		<div class="modal-dialog" role="document" style="margin:0px auto;margin-top:100px;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel"><i class="fa fa-exclamation-triangle fa-2x"></i> Eliminar Cajero</h4>
				</div>
				<form id="formEliminarUsuario" action="cajero" method="post">
					<div class="modal-body">

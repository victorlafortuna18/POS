	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<!--<input type="hidden" name="localidadid" id="localidadid" value="{{ $lastOrdenID }}">-->
		...
		<div class="modal-dialog" role="document" style="margin:0px auto;margin-top:100px;width:800px;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel"><i class="fa fa-pencil-square-o"></i>Orden</h4>
				</div>
				<form id="formAsignarOrden" action="ordenes" method="post">
					...
					<div class="modal-body" style="display:none;width:250px;background:;float:left;">
							...
							@else
								...
								@foreach($mensajeros as $mensajero)
									@if($mensajero->EstatusActual == 2)
										<span style="display:block;padding:3px;margin-bottom:3px;border-left: 5px solid #FF0000;font-weight:bold;box-sizing:border-box;" name="{{ $mensajero->id }}" data-mensajeroID="{{ $mensajero->id }}" data-estatus="2" title="Ocupado">{{ $mensajero->nombreUsuario }}</span>
									@endif
								@endforeach
								@foreach($mensajeros as $mensajero)
					...
					<div class="modal-footer" style="background:;">
						<a id="CancelarAsignarOrden" type="button" class="btn btn-default" data-dismiss="modal">Aceptar</a>

					...
					<div class="panel-body">
						...
						<div class="list-group">
							<table id="tablaPedidos" class="display" cellspacing="0" width="100%">
								...
								<tr>
									<td>
										<a href="{{ url('admin/consultorder/'.$pedido->tracking_id) }}" id="itemPedido" name="{{$pedido->id}}">{{$pedido->orden}}</a> 
										...
										<a href="#" id="editarPedido" class="editarPedido" data-id="{{ $pedido->id }}" data-orden="{{ $pedido->orden }}" data-tracking-id="{{ $pedido->tracking_id }}" style="margin-right:15px;float:right;"><i class="fa fa-pencil-square-o"></i></a>-->
									</td>
		...
		<div class="modal-dialog" role="document" style="margin:0px auto;margin-top:100px;">
			<div class="modal-content">
				...
				<form id="formEditarSucursal" action="sucursal" method="post">
					<div class="modal-body">
							<div id="formEditarConteoMensajeros" style="padding:5px;margin-right:10px;float:left;border-radius: 3px;border: 1px solid #d1d1d1;color: #fff;background-color: #337ab7;border-color: #2e6da4;font-weight: bold;"><i class="fa fa-motorcycle"></i> <span class="contador">0</span></div>
							<div id="formEditarConteoOperadores" style="padding:5px;margin-right:10px;float:left;border-radius: 3px;border: 1px solid #d1d1d1;color: #fff;background-color: #337ab7;border-color: #2e6da4;font-weight: bold;"><i class="fa fa-user"></i> <span class="contador">0</span></div>
							<input type="hidden" name="_token" value="{{ csrf_token() }}">

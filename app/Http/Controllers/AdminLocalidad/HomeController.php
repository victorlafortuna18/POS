...
namespace SmartDelivery\Http\Controllers\AdminLocalidad;
...
class HomeController extends BaseController {
	...
	public function showAdminUsuario()
    {
		...
		**************************************************/
        ...
        return view('adminlocalidad.usuario', compact('cuentas','sucursales','usuarios','mensajeros','ordenes','pedidos'));
    }
	...
	public function showAdminCajero()
    {
		...
		**************************************************/
		...
		//Aqui es donde despacho toda la data a la vista sucursal de la sesion admin
        return view('adminlocalidad.cajero', compact('cuentas','sucursales','usuarios','mensajeros','ordenes','pedidos'));
    }
	...
	public function showAdminMensajero()
    {
		...
		**************************************************/
		...
		//Aqui es donde despacho toda la data a la vista sucursal de la sesion admin
        return view('adminlocalidad.mensajero', compact('cuentas','sucursales','usuarios','mensajeros','ordenes','pedidos'));
...
//			 $hasta = $request->input('hasta');
	...
	public function showAdminEditCajero(Request $request)
    {
		...
		**************************************************/
		...
		if($request->input('asunto') == 'guardarUsuario'){
			...
			if($operador == true){
				return redirect()->action('AdminLocalidad\HomeController@showAdminCajero', array('agregado' => 'success', '#'.$operador->id));
			}else{
				return redirect()->action('AdminLocalidad\HomeController@showAdminCajero', array('agregado' => 'error'));
			}
		}
		elseif($request->input('asunto') == 'eliminarUsuario'){
			try {
			...
			if($operador == true){
				return redirect()->action('AdminLocalidad\HomeController@showAdminCajero', array('eliminado' => 'success'));
			}else{
				return redirect()->action('AdminLocalidad\HomeController@showAdminCajero', array('eliminado' => 'error'));
			}
		}
		elseif($request->input('asunto') == 'editarUsuario'){
			...
			if($operador == true){
				return redirect()->action('AdminLocalidad\HomeController@showAdminCajero', array('editado' => 'success','#'.$request->input('id')));
			}else{
				return redirect()->action('AdminLocalidad\HomeController@showAdminCajero', array('editado' => 'error'));
			}
		}
		elseif($request->input('asunto') == 'editarUsuarioPassword'){
	...
	public function showAdminReporteSesion(Request $request)
    {
		...
		**************************************************/
		...
		//Aqui es donde despacho toda la data a la vista adminlocalidad/reportPedidoMensajero.blade.php
        return view('adminlocalidad.reportSesion', compact('cuentas','sucursales','usuarios','sesiones','countsesiones'), array('desde' => $request->input('desde'),'hasta' => $request->input('hasta')));
    }
	...
	public function showAdminReporteFactura($idsesion, Request $request)
    {
		...
		**************************************************/
		...
		//Aqui es donde despacho toda la data a la vista adminlocalidad/reportPedidoMensajero.blade.php
        return view('adminlocalidad.reportFactura', compact('cuentas','sucursales','usuarios','facturas','sesiones'), array('desde' => $request->input('desde'),'hasta' => $request->input('hasta')));
    }
